...
class TGDNormalizerTest {
    ...
    class NormalizeSetOfTGDs {
            ...
            return Stream.of(
                    ...
                    Arguments.of(
                            ...
                            Set.of(
                                    "P(x) -> AUX3(x, y)",
                                    "AUX3(x, y) -> AUX4(x, y, z)",
                                    "AUX4(x, y, z) -> AUX2(x, y, z)",
                                    "AUX2(x, y, z) -> A1(x)",
                                    "AUX2(x, y, z) -> A2(x, y, z)",
                                    "Q(x), AUX1(x) -> AUX6(x, y)",
                                    "AUX6(x, y) -> AUX7(x, y, z)",
                                    "AUX7(x, y, z) -> AUX5(x, y, z)",
                                    "AUX5(x, y, z) -> A3(x)",
                                    "AUX5(x, y, z) -> A4(x, y, z)"
                            )
                    )
        ...
        void should_return_TGDs_normalized(List<String> originalsTGDsString, Set<String> expectedTGDsString) {
            ...
            TGDNormalizer tgdNormalizer = new TGDNormalizer();
    ...
    class OneTGD {
        ...
        class NormalizeOneTGD {
            ...
            void should_return_TGDs_normalized(String tgdString, Set<String> expectedTGDsString) {
                ...
                Set<TGD> normalizedTGD = tgdNormalizer.normalize(tgd);
        ...
        class NormalizeOneTGD_To_OneHeadAtom {
            ...
            void should_return_TGDs_only_oneHeadAtom(String tgdString, Set<String> expectedTGDsString) {
                ...
                Set<TGD> normalizedTGD = tgdNormalizer.normalizeWithOneHeadAtom(tgd);
        ...
        class NormalizeOneTGD_ExistentiallyQuantifiedVariables {
            ...
            void should_return_TGDs_only_oneExistentiallyQuantifiedVariable_when_TGD_containsSeveralExistentiallyQuantifiedVariables(String tgdString, Set<String> expectedTGDsString) {
                ...
                Set<TGD> normalizedTGD = tgdNormalizer.normalizeExistentiallyQuantifiedVariables(tgd);
        ...
        class OneTGDIsNormalForm {
            ...
            void isNormalForm(String tgdString) {
                TGD tgd = TGDMother.createTGD(tgdString);
                boolean isNormalForm = TGDNormalizer.isNormalForm(tgd);
                assertThat(isNormalForm).as("Should be normal form").isTrue();
            }
            ...
            void isNotNormalForm(String tgdString) {
                TGD tgd = TGDMother.createTGD(tgdString);
                boolean isNormalForm = TGDNormalizer.isNormalForm(tgd);
                assertThat(isNormalForm).as(tgd + " should not be normal form").isFalse();
            }
        }
    }
